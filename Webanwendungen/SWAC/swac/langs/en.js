...
let core_en = {
    ...
    appoffline_title: 'Function offline not available',
    appoffline_pagedesc: 'Sorry, this function is not available when you are offline. Please connect to the internet to continue.',
    ...
    contenttype_jparseerr: 'The content could not be parsed as json.',
    updateavail: 'There is an update available. Restart the application to install.'
};
