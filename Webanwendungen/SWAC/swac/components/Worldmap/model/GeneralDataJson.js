...
//        console.log('height: ' + height);
    ...
    drawTooltip(movement) {
        ...
        if (typeof valueIdentifier[2] !== 'undefined') {
            ...
            // Show position area
            let valElem = tooltipbox.querySelector('.swac_worldmap3d_tooltip_value');
            valElem.classList.remove('swac_dontdisplay');

            let valueNameElem = tooltipbox.querySelector('.swac_worldmap3d_valuename');
            valueNameElem.innerHTML = valueName;
            let valueElem = tooltipbox.querySelector('.swac_worldmap3d_value');
